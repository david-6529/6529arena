  ...
  const required: ChecklistItem[] = [
    ...
    },
    {
      ...
      detail: status.waveBriefProvider.configured
        ? status.waveBriefProvider.provider === "ollama"
          ? "ollama check-ins can run against the local Ollama service."
      ...
      <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-zinc-700 dark:text-zinc-300">
            Concrete deployment checks for the first production check-in loop for The Doomed Signal.
          </p>
        </div>
