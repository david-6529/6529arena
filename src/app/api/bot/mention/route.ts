  ...
  try {
    ...
    if (existingBrief) {
      await logEvent({
        ...
        actor: "bot",
        message: "Bot mention reused an existing wave summary draft for the trigger drop.",
        metadata: {
          waveId: body.waveId,
          triggerDropId: body.dropId,
    ...
    await logEvent({
      ...
      entityId: brief.id,
      actor: "bot",
      message: "Bot mention created a reviewed wave summary draft instead of public autoposting.",
      metadata: {
        waveId: body.waveId,
        triggerDropId: body.dropId,
        idempotencyKey: body.idempotencyKey,
